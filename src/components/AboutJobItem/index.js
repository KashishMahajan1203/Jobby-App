...
import {AiFillStar} from 'react-icons/bi'
import {BiLinkExxternal} from 'react-loader-spinner'
  ...
  getJobData = async props => {
    ...
    if (responseJobData.ok === true) {
      ...
      const updatedSimilarJobDetails = fetchedJobData.similar_jobs.map(
        eachItem => ({
          companyLogoUrl: eachItem.company_logo_url,
          jobDescription: eachItem.employment_type,
          location: eachItem.location,
          rating: eachItem.rating,
          title: eachItem.title,
        }),
      ...
      return (
        <>
          <div className="job-item-container">
            ...
            <h1 className="simialr-jobs-heading">Similar Jobs</h1>
            <ul className="simialr-jobs-ul-container">
